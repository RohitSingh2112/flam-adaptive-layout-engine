...
import { Smartphone, Monitor, Tv, AlertCircle, Eye, Layers, SlidersHorizontal, X } from 'lucide-react';
...
export const App: React.FC = () => {
  ...
  // Build the AdSpec dynamically from contentConfig
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col items-center p-4 sm:p-8">
      ...
      {/* Content Options Card (Expandable Drawer) */}
      {showContentOptions && (
        <div className="w-full max-w-2xl bg-slate-900/95 border border-slate-800 rounded-2xl p-5 mb-6 text-xs space-y-4 shadow-2xl animate-fadeIn">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-slate-400 font-medium mb-1">CTA Accent Color</label>
              <div className="flex items-center gap-2">
                <input
                  type="color"
